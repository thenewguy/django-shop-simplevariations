...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextOption.required'
        db.add_column('shop_simplevariations_textoption', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OptionGroup.required'
        db.add_column('shop_simplevariations_optiongroup', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextOption.required'
        db.delete_column('shop_simplevariations_textoption', 'required')

        # Deleting field 'OptionGroup.required'
        db.delete_column('shop_simplevariations_optiongroup', 'required')
