...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartItemOption.group'
        db.add_column('shop_simplevariations_cartitemoption', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop_simplevariations.OptionGroup'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CartItemOption.choice'
        db.add_column('shop_simplevariations_cartitemoption', 'choice',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartItemOption.group'
        db.delete_column('shop_simplevariations_cartitemoption', 'group_id')

        # Deleting field 'CartItemOption.choice'
        db.delete_column('shop_simplevariations_cartitemoption', 'choice')
    ...
    models = {
        ...
        'shop_simplevariations.cartitemoption': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop_simplevariations.OptionGroup']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
