...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionGroup.subgroup'
        db.add_column('shop_simplevariations_optiongroup', 'subgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop_simplevariations.OptionGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionGroup.subgroup'
        db.delete_column('shop_simplevariations_optiongroup', 'subgroup_id')
