...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionGroup.choose_count'
        db.add_column('shop_simplevariations_optiongroup', 'choose_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionGroup.choose_count'
        db.delete_column('shop_simplevariations_optiongroup', 'choose_count')
