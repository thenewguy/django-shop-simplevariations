...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CartItemOption.group'
        db.alter_column('shop_simplevariations_cartitemoption', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop_simplevariations.OptionGroup'], null=True))
