...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextOption.max_length'
        db.add_column('shop_simplevariations_textoption', 'max_length',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'CartItemTextOption.text'
        db.alter_column('shop_simplevariations_cartitemtextoption', 'text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'TextOption.max_length'
        db.delete_column('shop_simplevariations_textoption', 'max_length')


        # Changing field 'CartItemTextOption.text'
        db.alter_column('shop_simplevariations_cartitemtextoption', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))
